...
[CreateAssetMenu(menuName="uRPG Item/Equipment", order=999)]
public class EquipmentItem : UsableItem
{
    ...
    public override Usability CanUse(PlayerEquipment equipment, int hotbarIndex, Vector3 lookAt) { return Usability.Never; }
